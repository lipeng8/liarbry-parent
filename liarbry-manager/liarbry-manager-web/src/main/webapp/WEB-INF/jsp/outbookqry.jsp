...
%>
<table class="easyui-datagrid" id="QryStuList" title="借阅图书列表" style="position: relative"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/book/QryStu',method:'get',pageSize:30,toolbar:toolbar">
    <thead>
    <tr>
...
<script>
    function qryById() {
        ...
        $("#QryStuList").datagrid({
            url: '/book/outQry?out_st_id=' + student_id
        });
    }
    ...
    function qryByName() {
        ...
        $("#QryStuList").datagrid({
            url: '/book/outQry?studentName=' + student_name
        });
    }
