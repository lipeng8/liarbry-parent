...
%>
<table class="easyui-datagrid" id="teacherList" title="借阅图书列表" style="position: relative"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/book/teaQryStu?teacher_id=<%=opId%>',method:'get',pageSize:30,toolbar:toolbar">
    <thead>
    <tr>
...
<script>
    function qryById(){
        ...
        $("#teacherList").datagrid({
            url:'/book/teaOutQry?teacher_id=<%=opId%>&out_st_id='+student_id
        });
    }
    function qryByName(){
        ...
        /*String studentName,Integer out_st_id, Integer page, Integer rows*/
        $("#teacherList").datagrid({
            url:'/book/teaOutQry?teacher_id=<%=opId%>&studentName='+student_name
        });
    }
