        ...
        <div data-options="region:'center'" style="padding:5px">
		    ...
		    <thead>
		        <tr>
		            ...
		            <th data-options="field:'url',width:60,align:'center',formatter:LIBRARY.formatUrl">内容连接</th>
		            <th data-options="field:'pic',width:50,align:'center',formatter:LIBRARY.formatUrl">图片</th>
		            <th data-options="field:'pic2',width:50,align:'center',formatter:LIBRARY.formatUrl">图片2</th>
