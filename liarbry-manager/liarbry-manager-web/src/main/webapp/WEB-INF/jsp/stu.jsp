...
%>
<table class="easyui-datagrid" id="stuList" title="学生列表" style="position: relative"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/book/student',method:'get',pageSize:30,toolbar:toolbar">
    <thead>
    <tr>
...
<script>
    function qryById(){
        ...
        $("#stuList").datagrid({
            url:'/book/studentId?studentName=null&teacher_id=<%=opId%>&page=1&rows=50&studentId='+student_id
        });
    }
    ...
    function qryByName(){
        ...
        $("#stuList").datagrid({
            url:'/book/studentName?studentName='+student_name+'&teacher_id=<%=opId%>&page=1&rows=50&studentId=0'
        });
    }
